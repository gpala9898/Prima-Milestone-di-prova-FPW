...
<header class="header clearfix">
            ...
            <ul class="header_menu">
                ...
                <li class="header_menu_el"><a href="articoli.html?uid=${utente.getId()}"><p style="font-family: arial">Articoli</p></a></li>
                <li class="header_menu_el"><a href=""><p style="font-family: arial">Valutazioni</p></a></li>
                <li class="header_menu_el"><a href="profilo.html?uid=${utente.getId()}"><p style="font-family: arial">Profilo</p></a></li>
                                   </c:when>
                               </c:choose>
